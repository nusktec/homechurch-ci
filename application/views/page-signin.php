                    ...
                    <div class="wd-100p" id="app">
                        ...
                        <form onsubmit="return false" id="form1" class="needs-validation" novalidate autocomplete="off">
                            <div class="form-group">
                                ...
                                <input v-model="user.email" :disabled="disabled" type="email" class="form-control" placeholder="yourname@yourmail.com">
                            </div>
                            <div class="form-group">
                                ...
                                <input v-model="user.pass1" :disabled="disabled" type="password" class="form-control" placeholder="Enter your password">
                            </div>
                            ...
                            <div class="tx-13 mg-t-20 tx-center">Don't have an account? <a href="<?php echo site_url(); ?>create-account">Create an
                                    Account</a></div>
                        </form>
                    </div>
                </div><!-- sign-wrapper -->
