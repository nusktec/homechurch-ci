...
<header class="navbar navbar-header navbar-header-fixed sticky-top">
    ...
    <div id="navbarMenu" class="navbar-menu-wrapper">
        ...
        <ul class="nav navbar-menu">
            ...
            <li class="nav-item with-sub <?php echo $menu_code == 0 ? 'active' : ''; ?>">
                <a href="<?php echo base_url(); ?>" class="nav-link"><i data-feather="user"></i> Quick Links</a>
        ...
        <div class="navbar-right">
            ...
            <div class="dropdown dropdown-notification">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a href="" class="dropdown-item">
                        <div class="media">
                            <div class="avatar avatar-sm avatar-online"><img src="http://via.placeholder.com/350"
                                                                             class="rounded-circle" alt=""></div>
                            <div class="media-body mg-l-15">
