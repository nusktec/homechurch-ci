...
class Template extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $meta['desc'] = "Description"; //descriptionn
        $meta['rm'] = 1; //menu num
        $meta['menu_num'] = -1; //active menu code
        $meta['institute'] = $this->institue; //institute data
        $meta['user'] = $this->user; //user data
        $meta['acctype'] = (int)$this->user['utype']; //user data
        $meta['avatar'] = $this->muser->profileImg($this->uid, $this->utemp['ugender']); //profile pics
        ...
        $meta['script'] = ['super-home']; //script to be loaded in array
        //load child view first
        $meta['contents'] = $this->load->view("super/super-classes", $meta, true);
