...
class chats extends CI_Controller
{
    ...
    {
        $meta['title'] = "Chats"; //title
        $meta['desc'] = "Home Church Chat"; //description
        $meta['rm'] = 5; //right menu num
        ...
        $meta['script'] = ['user-chats', 'side-bar']; //script to be loaded in array
        //load child view first
        $meta['contents'] = $this->load->view("user/page-chats", $meta, true);
