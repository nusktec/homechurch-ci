...
class wordEditor extends CI_Controller
{
    public $uid = null;
    public $utemp = null;
    public $user = null;
    ...
    public function index()
    {
        ...
        $meta['desc'] = "Dashboard"; //description
        ...
        $meta['script'] = ['user-home', 'side-bar','helpers','wordEditor']; //script to be loaded in array
        //load child view first
        $meta['contents'] = $this->load->view("wordEditor", $meta, true);
